-- User 데이터 생성
INSERT INTO user(coin_count,email,introduction,name,opened,password,premium,img,refresh_token) VALUES (0,"tester1@gmail.com","안녕하세요!","tester1",false,"{bcrypt}$2a$10$cp..8Z39B0WvHRd2MT/tl.qKUhZXATcBDxGn6nE.nAMU2GpRjEAe.",false,"/image/1.jpg",""); -- 비밀번호 : abcdefgh
INSERT INTO user(coin_count,email,introduction,name,opened,password,premium,img,refresh_token) VALUES (0,"tester2@gmail.com","반가워요","tester2",false,"{bcrypt}$2a$10$cp..8Z39B0WvHRd2MT/tl.qKUhZXATcBDxGn6nE.nAMU2GpRjEAe.",false,"/image/1.jpg","");
INSERT INTO user(coin_count,email,introduction,name,opened,password,premium,img,refresh_token) VALUES (0,"tester3@gmail.com","열심히 해봐요","tester3",false,"{bcrypt}$2a$10$cp..8Z39B0WvHRd2MT/tl.qKUhZXATcBDxGn6nE.nAMU2GpRjEAe.",false,"/image/me.jpg","");
INSERT INTO user(coin_count,email,introduction,name,opened,password,premium,img,refresh_token) VALUES (0,"tester4@gmail.com","","tester4",false,"{bcrypt}$2a$10$cp..8Z39B0WvHRd2MT/tl.qKUhZXATcBDxGn6nE.nAMU2GpRjEAe.",false,"/image/1.jpg","");
INSERT INTO user(coin_count,email,introduction,name,opened,password,premium,img,refresh_token) VALUES (0,"tester5@gmail.com","오늘부터 시작","tester5",false,"{bcrypt}$2a$10$cp..8Z39B0WvHRd2MT/tl.qKUhZXATcBDxGn6nE.nAMU2GpRjEAe.",false,"/image/user.jpg","");
INSERT INTO user(coin_count,email,introduction,name,opened,password,premium,img,refresh_token) VALUES (0,"tester6@gmail.com","","tester6",false,"{bcrypt}$2a$10$cp..8Z39B0WvHRd2MT/tl.qKUhZXATcBDxGn6nE.nAMU2GpRjEAe.",false,"/image/1.jpg","");
INSERT INTO user(coin_count,email,introduction,name,opened,password,premium,img,refresh_token) VALUES (0,"tester7@gmail.com","화이팅!","tester7",false,"{bcrypt}$2a$10$cp..8Z39B0WvHRd2MT/tl.qKUhZXATcBDxGn6nE.nAMU2GpRjEAe.",false,"/image/1.jpg","");
INSERT INTO user(coin_count,email,introduction,name,opened,password,premium,img,refresh_token) VALUES (1,"tester8@gmail.com","만나서 반가워요","tester8",false,"{bcrypt}$2a$10$cp..8Z39B0WvHRd2MT/tl.qKUhZXATcBDxGn6nE.nAMU2GpRjEAe.",false,"/image/hi.jpg","");
INSERT INTO user(coin_count,email,introduction,name,opened,password,premium,img,refresh_token) VALUES (2,"tester9@gmail.com","","tester9",false,"{bcrypt}$2a$10$cp..8Z39B0WvHRd2MT/tl.qKUhZXATcBDxGn6nE.nAMU2GpRjEAe.",false,"/image/1.jpg","");
INSERT INTO user(coin_count,email,introduction,name,opened,password,premium,img,refresh_token) VALUES (2,"tester10@gmail.com","","tester10",false,"{bcrypt}$2a$10$cp..8Z39B0WvHRd2MT/tl.qKUhZXATcBDxGn6nE.nAMU2GpRjEAe.",false,"/image/1.jpg","");
